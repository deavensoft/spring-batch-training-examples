package com.deavensoft.springbatchtraining.testapp;
...
import com.deavensoft.springbatchtraining.testapp.service.BookDetailsItemProcessor;
import com.deavensoft.springbatchtraining.testapp.service.BookItemProcessor;
import com.deavensoft.springbatchtraining.testapp.service.BookRecordFieldSetMapper;
...
public class SpringBatchConfiguration {
  ...
  public JsonFileItemWriter<Book> jsonItemWriter(@Value("#{jobParameters['file.output']}") String output) throws IOException {
    ...
    log.info("Configuring writer to output {}", output);
    // @formatter:off
    return builder
        .name("bookItemWriter")
